...
int32 xSTStartup(PACKER_ASSETTYPE* handlers) STUB
...
int32 xSTGetAssetInfo(uint32 aid, PKR_ASSET_TOCINFO* tocainfo) STUB
int32 xSTGetAssetInfoByType(uint32 type, int32 idx, PKR_ASSET_TOCINFO* ainfo) STUB
int32 xSTGetAssetInfoInHxP(uint32, PKR_ASSET_TOCINFO*, uint32) STUB
char* xST_xAssetID_HIPFullPath(uint32 aid) STUB
char* xST_xAssetID_HIPFullPath(uint32 aid, uint32* sceneID) STUB
static int32 XST_PreLoadScene(STRAN_SCENE*, const char*) STUB
...
static STRAN_SCENE* XST_lock_next() STUB
static void XST_unlock(STRAN_SCENE*) STUB_VOID
static void XST_unlock_all() STUB_VOID
static STRAN_SCENE* XST_get_rawinst(int32) STUB
static int32 XST_cnt_locked() STUB
static STRAN_SCENE* XST_nth_locked(int32) STUB
static STRAN_SCENE* XST_find_bySID(uint32 sid, bool32 findTheHOP) STUB