...
inline uint32 xEntERIsExtending(const xEntMotion*) STUB
inline uint32 xEntERIsExtended(const xEntMotion*) STUB
inline uint32 xEntERIsRetracting(const xEntMotion*) STUB
...
inline uint32 xEntMotionIsStopped(const xEntMotion*) STUB