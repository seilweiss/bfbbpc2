...
st_XSAVEGAME_DATA* zSaveLoadSGInit(en_SAVEGAME_MODE);
int32 zSaveLoadSGDone(st_XSAVEGAME_DATA*);
...
int32 zSaveLoad_CardCheckGamesSingle_doCheck(st_XSAVEGAME_DATA*, int32);
...
bool32 xSGT_SaveInfoCB(void*, st_XSAVEGAME_DATA*, int32* need, int32* most);
bool32 xSGT_SaveProcCB(void*, st_XSAVEGAME_DATA* xsgdata, st_XSAVEGAME_WRITECONTEXT* wctxt);
bool32 xSGT_SaveInfoPrefsCB(void*, st_XSAVEGAME_DATA*, int32* need, int32* most);
bool32 xSGT_SaveProcPrefsCB(void*, st_XSAVEGAME_DATA* xsgdata, st_XSAVEGAME_WRITECONTEXT* wctxt);
bool32 xSGT_LoadLoadCB(void*, st_XSAVEGAME_DATA* xsgdata, st_XSAVEGAME_READCONTEXT* rctxt, uint32, int32);
bool32 xSGT_LoadPrefsCB(void*, st_XSAVEGAME_DATA* xsgdata, st_XSAVEGAME_READCONTEXT* rctxt, uint32, int32);
