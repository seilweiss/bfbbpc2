...
bool32 zNPCGoalPushAnim::Process(en_trantype* trantype, float32 dt, void* updCtxt, xScene* xscn) STUB

bool32 zNPCGoalLoopAnim::Enter(float32 dt, void* updCtxt) STUB
bool32 zNPCGoalLoopAnim::Exit(float32, void*) STUB
bool32 zNPCGoalLoopAnim::Process(en_trantype* trantype, float32 dt, void* updCtxt, xScene* xscn) STUB
...
bool32 zNPCGoalIdle::Process(en_trantype* trantype, float32 dt, void* updCtxt, xScene* xscn) STUB
...
bool32 zNPCGoalPatrol::Process(en_trantype* trantype, float32 dt, void* updCtxt, xScene*) STUB
void zNPCGoalPatrol::DoOnArriveStuff() STUB_VOID
void zNPCGoalPatrol::PickTransition(int32*, en_trantype*) STUB_VOID
...
bool32 zNPCGoalWander::Process(en_trantype* trantype, float32 dt, void* updCtxt, xScene*) STUB
...
bool32 zNPCGoalWaiting::Process(en_trantype* trantype, float32 dt, void* updCtxt, xScene*) STUB
...
bool32 zNPCGoalDEVAnimCycle::Process(en_trantype* trantype, float32 dt, void* updCtxt, xScene*) STUB
...
bool32 zNPCGoalDEVAnimSpin::Process(en_trantype* trantype, float32 dt, void* updCtxt, xScene*) STUB
...
bool32 zNPCGoalDEVHero::Process(en_trantype* trantype, float32 dt, void* updCtxt, xScene*) STUB
